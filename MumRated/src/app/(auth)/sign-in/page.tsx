        ...
        <div className="card p-8 space-y-6">
          ...
          {sent ? (
            <div className="rounded-card bg-[#F0F7F2] border border-[#A8D5B5] px-4 py-4 text-center space-y-1">
              <p className="text-sm font-semibold text-[#2A6B3A]">
                Check your inbox ✓
              </p>
              <p className="text-xs text-[#3B6B4A]">
                We sent a magic link to{" "}
                <strong className="font-medium">{email}</strong>. Click it to
                sign in — the link expires in 10 minutes.
              </p>
              <button
                onClick={() => {
                  setSent(false);
          ...
          <p className="text-center text-xs text-muted">
            ...
            <Link href="/terms" className="underline underline-offset-2 hover:text-dark">
              terms
            </Link>{" "}
            and{" "}
            <Link href="/privacy" className="underline underline-offset-2 hover:text-dark">
              privacy policy
            </Link>
            .
          </p>
